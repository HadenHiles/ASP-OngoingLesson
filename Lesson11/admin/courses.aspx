<%@ Page Title="" Language="C#" MasterPageFile="~/Lesson.Master" AutoEventWireup="true" CodeBehind="courses.aspx.cs" Inherits="Lesson11.courses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="grdCourses" runat="server" CssClass="table table-striped"
        ...
        AllowPaging="true"
        OnPageIndexChanging="grdCourses_PageIndexChanging"
        PageSize="3"
        AllowSorting="true"
